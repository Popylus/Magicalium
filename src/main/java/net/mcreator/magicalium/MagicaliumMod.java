package net.mcreator.magicalium;
...
@Mod("magicalium")
public class MagicaliumMod {
	public static final Logger LOGGER = LogManager.getLogger(MagicaliumMod.class);
	public static final String MODID = "magicalium";

	public MagicaliumMod() {
		...
		MagicaliumModMobEffects.REGISTRY.register(bus);
