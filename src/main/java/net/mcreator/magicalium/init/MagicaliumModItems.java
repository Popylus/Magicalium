...
public class MagicaliumModItems {
	...
	public static final RegistryObject<Item> GRAVITO_SPAWN_EGG = REGISTRY.register("gravito_spawn_egg", () -> new ForgeSpawnEggItem(MagicaliumModEntities.GRAVITO, -1, -1, new Item.Properties()));
